...
check_state_4:
    cjne   @R0, #STATE_WAIT_I2C, check_state_5
    jnb    I2_BIT_NOW, __return  ; wait till I2C done
    sjmp   go_next_step
...
wait_post_d34:
    jb      POSTBIT, wait_post_d34

wait_for_reset:
    djnz    R2, wait_for_reset
    djnz    R3, wait_for_reset
...
check_nand_activity:
    orl    A, 0EEh
    djnz   R2, check_nand_activity
    djnz   R3, check_nand_activity
    jnz    go_next_step
    ; no NAND activity - fail, do reboot
